...
#
# Usage:
#   tool/build-openssl-android.sh [abi]        # default arm64-v8a
#
...
# anyone from checking. tool/android.mk exports ANDROID_API so a build
...
## Generated by tool/build-openssl-android.sh -- see the note there.
